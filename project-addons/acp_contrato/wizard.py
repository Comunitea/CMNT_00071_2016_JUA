        ...
        for contrato in cr.dictfetchall():
            ...
            if contrato['contratado'] == True:
                ...
                if total == 0:
                    serv = {
                        'contrato_id': contrato['id'],
                        'fecha': contrato['dia_servicio']  + '/' + mes + '/' + str(ano) + ' 00:00:00' ,
                        'partner_id': contrato['cliente_id'],
                    ...
                    #Recupera la lista de materiales
                    #este proceso ya se hace automaticamente al crear el servidcio
                    '''
                    if contrato['carga_materiales'] == True:
                        print "<<<<<<<<<<<<<<<<<<<<  contrato['servicio_prog_id']: ",contrato['servicio_prog_id']
                        cr.execute("select id,contrato_id,ubicacion,estado,product_id, \
                                    observaciones,tipo_producto_n,prodlot_id \
                                    from acp_contrato_contrato_producto \
                        ...
                        for serv_mat in cr.dictfetchall():  
                            ...
                            serv_material = {
                                'servicio_id': serv_id,
                                'contrato_id': serv_mat['contrato_id'],
